...
class CalculatorTest {
    ...
    @Test
    @DisplayName("Square root of perfect square")
    ...
    @Test
    @DisplayName("Square root of non-perfect square")
    void testSquareRootNonPerfectSquare() {
